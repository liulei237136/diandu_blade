 <div class="tw-flex tw-items-center">
     <a href="{{ $repository->link() }}"
         class="hover:tw-text-black  tw-no-underline tw-px-4 tw-py-2 tw-flex tw-items-center tw-text-black tw-border-b
     ...
     <a href="{{ route('repository_audio.show', ['repository' => $repository]) }}"
        ...
        hover:tw-text-black  tw-text-black  tw-border-b tw-no-underline tw-px-4 tw-py-2 tw-flex tw-items-center  hover:tw-border-b hover:tw-border-gray-400">
         <x-icon name="audio" class="tw-hidden md:tw-block tw-w-4 tw-h-4 tw-mr-1" />
         <span>包含音频</span>
     </a>
     <a href="{{ $repository->link('repository_comments.show') }}"
         class="{{ if_route('repository_comments.show') ? ' tw-border-b-red-500' : '' }} tw-border-b  tw-no-underline  tw-px-4 tw-py-2 tw-flex tw-items-center tw-text-black hover:tw-text-black  hover:tw-border-gray-400">
