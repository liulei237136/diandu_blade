        ...
        <div class="col-md-10 offset-md-1">
            <div class="card ">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('suggestions.store') }}" method="POST" accept-charset="UTF-8">

                        @csrf

                        <div class="form-group mb-3">
                            <label for="suggestion_title" class="tw-mb-1">建议标题:</label>
                            <input id="tuttorial_title" class="form-control" name="title"
                                value="{{ old('title', $suggestion->title) }}" placeholder="最少3个字符" />
                        </div>
